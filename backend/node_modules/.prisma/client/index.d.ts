  ...
  */
  ...
  export type NoteGetPayload<S extends boolean | null | undefined | NoteArgs> =
    ...
    : S extends { select: any } & (NoteArgs | NoteFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'createdBy' ? UserGetPayload<S['select'][P]> :  P extends keyof Note ? Note[P] : never
  } 
      : Note
  ...
  export type CommentGetPayload<S extends boolean | null | undefined | CommentArgs> =
    ...
    : S extends { select: any } & (CommentArgs | CommentFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'createdBy' ? UserGetPayload<S['select'][P]> :  P extends keyof Comment ? Comment[P] : never
  } 
      : Comment
